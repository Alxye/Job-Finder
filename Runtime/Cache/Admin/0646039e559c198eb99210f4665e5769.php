...
<div class="page-content">
	<div class="page-header">
		<h1>
			...
			<small>
				<i class="icon-double-angle-right"></i>
				<?php if((ACTION_NAME) == "edit"): ?>修改角色<?php else: ?>添加角色<?php endif; ?>
			</small>
		</h1>
	</div>
	<!-- /.page-header -->
			...
			<div class="row">
				<div class="tabbable">
					...
					<div class="tab-content">
						<div class="row">
							<div class="col-xs-4">
								<form class="form-horizontal" id="ajaxForm" action='<?php if((ACTION_NAME) == "edit"): echo U("Role/update"); else: echo U("Role/insert"); endif; ?>' method="post">
									<input type="hidden" name="id" value="<?php echo ($data["id"]); ?>"/>
									<div class="space-10"></div>
									<div class="form-group">
										<label class="col-sm-3 control-label"> 角色名 </label>
										<div class="col-sm-9">
											<input type="text"  name="name" value="<?php echo ($data["name"]); ?>" placeholder="英文名称"/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label"> 角色昵称 </label>
										<div class="col-sm-9">
											<input type="text"  name="remark" value="<?php echo ($data["remark"]); ?>" placeholder="中文名称"/>
										</div>
									</div>
									<div class="form-group">
