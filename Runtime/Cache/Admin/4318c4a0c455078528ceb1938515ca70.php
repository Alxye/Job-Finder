			...
			<div class="row">
				<div class="tabbable">
					...
					<div class="tab-content">
						<div class="row">
							<div class="col-xs-4">
								<form class="form-horizontal" id="ajaxForm" action='<?php if((ACTION_NAME) == "edit"): echo U("Category/update"); else: echo U("Category/insert"); endif; ?>' method="post">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class=" width-90 form-control cate" name="module" <?php echo ($moduleDisabled); ?> >
											<option value="">选择模块</option>
											<?php if(is_array($module)): foreach($module as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>" <?php if(($item["module"]) == $v["id"]): ?>selected<?php endif; ?>><?php echo ($v["tagname"]); ?></option><?php endforeach; endif; ?>
											</select>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select id="cate" class=" width-90 form-control cate" name="pid" <?php echo ($disabled); ?> >
												<option value="0">作为主分类</option>
												<?php if(is_array($list)): foreach($list as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>" <?php echo ($v["selected"]); ?>><?php echo ($v["name"]); ?></option><?php endforeach; endif; ?>
											</select>
											<script>
												seajs.use(["$"],function($){
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text"  name="sort" value="<?php echo ($item["sort"]); ?>"  class="col-xs-3"/>
										</div>
									</div>
									<hr/>
									<div class="center">
