			...
			<div class="row">
				<div class="tabbable">
					...
					<div class="tab-content">
						<div class="row">
							<div class="col-xs-4">
								<form class="form-horizontal" id="ajaxForm" action='<?php if((ACTION_NAME) == "edit"): echo U("Tag/update"); else: echo U("Tag/insert"); endif; ?>' method="post">
									<input type="hidden" name="id" value="<?php echo ($item["id"]); ?>"/>
									<hr/>
									<div class="form-group">
										<label class="col-sm-3 control-label" >上级标签</label>

										<div class="col-sm-9">
											<select class=" width-90 form-control cate" name="pid" <?php echo ($disabled); ?> >
												<option value="0">作为主标签</option>
												<?php if(is_array($list)): foreach($list as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>|<?php echo ($v["path"]); ?>" <?php echo ($v["selected"]); ?>><?php echo ($v["tagname"]); ?></option><?php endforeach; endif; ?>
											</select>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text"  name="tagname" value="<?php echo ($item["tagname"]); ?>"/>
										</div>
									</div>
									<hr/>
									<div class="center">
