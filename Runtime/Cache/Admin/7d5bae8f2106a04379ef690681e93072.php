...
<script type="text/javascript">
	seajs.use(['admin-common', '$', 'dataTables', "dataTables-bootstrap", 'bootbox'], function (admin, $) {
		var oTable = $('#sample-table').dataTable({
			...
			"aoColumns" : [ //列操作
				{"sClass" : "center", "mData" : "userid"},
				{
					...
					"mRender" : function(data){
						if(data == '<?php echo C("RBAC_SUPERADMIN");?>'){
				...
				},
				{
					...
					"mData" : "userid",
					"mRender" : function (data) {
						var editurl = "<?php echo U('Admin/edit');?>?uid=" + data;
						var delturl = "<?php echo U('Admin/delete');?>?uid=" + data;
			...
			"sAjaxSource" : "<?php echo U('Admin/lists');?>",
			"sServerMethod" : "POST",
			//"bProcessing": true,
