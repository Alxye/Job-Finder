			...
			<div class="row">
				<div class="tabbable">
					...
					<div class="tab-content">
						<form action="<?php echo U('Role/set');?>" method="post" id="ajaxForm">
						<?php if(is_array($list)): foreach($list as $key=>$module): ?><input type="hidden" name="id" value="<?php echo ($_GET['id']); ?>"/>
							<div class="module">
								<h3 class="header smaller lighter blue">
									<input name="nodeids[]" type="checkbox" class="ace" level="module" value="<?php echo ($module["id"]); ?>" <?php echo ($module["checked"]); ?>/>
									<span class="lbl"> <?php echo ($module["title"]); ?></span>
								</h3>
								<?php if(!empty($module["children"])): ?><div class="row">
									<?php if(is_array($module["children"])): foreach($module["children"] as $key=>$controller): ?><div class="col-xs-2 ">
												<div class="control-group">
													<label class="control-label bolder blue">
														<input name="nodeids[]" type="checkbox" class="ace" level="controller" value="<?php echo ($controller["id"]); ?>" <?php echo ($controller["checked"]); ?>/>
														<span class="lbl"> <?php echo ($controller["title"]); ?></span>
													</label>
													<?php if(!empty($controller["children"])): if(is_array($controller["children"])): foreach($controller["children"] as $key=>$action): ?><div class="checkbox">
														<label>
															<input name="nodeids[]" type="checkbox" class="ace" level="action" value="<?php echo ($action["id"]); ?>" <?php echo ($action["checked"]); ?>/>
															<span class="lbl"> <?php echo ($action["title"]); ?></span>
														</label>
