<?php if (!defined('THINK_PATH')) exit();?><!--导入页头和侧边栏-->
<!DOCTYPE html>
<html lang="cn">
<head>
	<meta charset="utf-8"/>
...
<div class="page-content">
	...
	<div class="wrap J_check_wrap">
		<form class="form-horizontal" action="<?php echo U('Setting/update');?>" method="post">
			<fieldset>
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" > 网站名称： </label>
					<div class="col-sm-7">
						<input type="text"  name="site_name"  class="col-xs-10 col-sm-5" value="<?php echo ($data["site_name"]); ?>"/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" > 网站域名： </label>
					<div class="col-sm-7">
						<input type="text"  name="site_host"  class="col-xs-10 col-sm-5" value="<?php echo ($data["site_host"]); ?>"/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" > 备案信息： </label>
					<div class="col-sm-9">
						<input type="text"  name="site_icp"  class="col-xs-10 col-sm-5" value="<?php echo ($data["site_icp"]); ?>"/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" > 站长邮箱： </label>
					<div class="col-sm-9">
						<input type="text"  name="site_email"  class="col-xs-10 col-sm-5" value="<?php echo ($data["site_email"]); ?>"/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" > SEO标题： </label>
					<div class="col-sm-9">
						<input type="text"  name="seo_title"  class="col-xs-10 col-sm-5" value="<?php echo ($data["seo_title"]); ?>"/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" > SEO关键字： </label>
					<div class="col-sm-9">
						<textarea  class="col-xs-5" rows="5" name="seo_keywords"><?php echo ($data["seo_keywords"]); ?></textarea>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" > SEO描述： </label>
					<div class="col-sm-9">
						<textarea  class="col-xs-5" rows="5" name="seo_content"><?php echo ($data["seo_content"]); ?></textarea>
					</div>
				</div>
