...
<div class="main-content">
	...
	<div class="page-content">
		<div class="page-header">
			<h1 style="color: #b33333">欢迎来到招聘后台管理系统</h1>
		</div>
		<!-- /.page-header -->
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="well">
					<h3 class="red smaller bold">登陆信息</h3>
				...
				<div class="well">
					<h3 class="red smaller bold">系统信息 </h3>
					<ul class="list-unstyled spaced2">
						<li>
				...
				<div class="well">
					<h3 class="red smaller bold">网站统计 </h3>
					<ul class="list-unstyled spaced2">
						<li>
							<i class="icon-male "></i>
							本日新增：<?php echo ($count_day["people"]); ?> 个人用户 || <?php echo ($count_day["company"]); ?> 企业用户 || <?php echo ($count_day["job"]); ?> 职位
						</li>
						<li>
							<i class="icon-archive "></i>
							本月新增：<?php echo ($count_month["people"]); ?> 个人用户 || <?php echo ($count_month["company"]); ?> 企业用户 || <?php echo ($count_month["job"]); ?> 职位
						</li>
						<li>
							<i class="icon-globe "></i>
							本年新增：<?php echo ($count_year["people"]); ?> 个人用户 || <?php echo ($count_year["company"]); ?> 企业用户 || <?php echo ($count_year["job"]); ?> 职位
						</li>
