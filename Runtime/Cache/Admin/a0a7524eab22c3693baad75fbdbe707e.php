		...
		var oTable = $('#sample-table').dataTable({
			...
			"aoColumns" : [ //列操作
				...
				},
				{
					...
					"mData" : "id",
					"mRender" : function (data) {
						var editurl = "<?php echo U('Role/edit');?>?id=" + data;
						var delturl = "<?php echo U('Role/delete');?>?id=" + data;
						var setturl = "<?php echo U('Role/set');?>?id=" + data;
			...
			"sAjaxSource" : "<?php echo U('Role/lists');?>",
			"sServerMethod" : "POST",
			//"bProcessing": true,
