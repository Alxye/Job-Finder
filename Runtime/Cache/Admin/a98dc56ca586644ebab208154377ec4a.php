				...
				<div class="tabbable">
					...
					<div class="tab-content">
						<div class="tab-pane in active">
							<form id="ajaxForm" class="form-horizontal" action='<?php echo U("Job/update");?>' method="post">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<p class="text-info form-control-static"><?php echo cateBread($data['cid']);?></p>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name="title" readonly class="col-xs-10 col-sm-5" value="<?php echo ($cname); ?>"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"> 标题党 </label>

									<div class="col-sm-9">
										<input type="text" name="title" class="col-xs-10 col-sm-5" value="<?php echo ($data["title"]); ?>"/>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name="name" class="col-xs-10 col-sm-5" value="<?php echo ($data["name"]); ?>"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"> 月薪 </label>
									<div class="col-sm-5">
										<input type="text" name="payid" class="col-xs-2" value="<?php echo ($data["payid"]); ?>"/><span class="middle">&nbsp;K&nbsp;&nbsp;（1K等于1000元）</span>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" name="num" class="col-xs-2" value="<?php echo ($data["num"]); ?>"/>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-2">
										<select name="cityid" class=" width-80 form-control">
											<option value="">选择城市</option>
											<?php if(is_array($citylist)): $i = 0; $__LIST__ = $citylist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value='<?php echo ($vo["id"]); ?>'
												<?php if(($vo["id"]) == $data["cityid"]): ?>selected<?php endif; ?>
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<select name="eid" class=" width-80 form-control">
											<option value="">要求学历</option>
											<?php if(is_array($elist)): $i = 0; $__LIST__ = $elist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value='<?php echo ($vo["id"]); ?>'
												<?php if(($vo["id"]) == $data["eid"]): ?>selected<?php endif; ?>
												><?php echo ($vo["tagname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
										</select>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"> 工作年限 </label>

									<div class="col-sm-2">
										<select name="year" class=" width-80 form-control">
											<option value="">工作年限</option>
											<?php if(is_array($yearlist)): $i = 0; $__LIST__ = $yearlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value='<?php echo ($vo["id"]); ?>'
												<?php if(($vo["id"]) == $data["year"]): ?>selected<?php endif; ?>
												><?php echo ($vo["tagname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
										</select>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"> 岗位职责 </label>

									<div class="col-sm-9">
										<textarea class="col-xs-8" rows="5" name="duty"><?php echo ($data["duty"]); ?></textarea>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"> 任职要求 </label>

									<div class="col-sm-9">
										<textarea class="col-xs-8" rows="5" name="request"><?php echo ($data["request"]); ?></textarea>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name="edittime" readonly class="input-sm"
										<?php if(($data["edittime"] == 0) OR ($data["edittime"] == null)): ?>value='无'
											<?php else: ?>
											value='<?php echo ($data["edittime"]); ?>'<?php endif; ?>
										/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"> 刷新次数 </label>

									<div class="col-sm-9">
										<input type="text" name="flushnum" readonly class="input-sm" value="<?php echo ($data["flushnum"]); ?>"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"> 被申请次数 </label>

									<div class="col-sm-9">
										<input type="text" name="applynum" readonly class="input-sm" value="<?php echo ($applynum); ?>"/>
									</div>
								</div>
								<div class="form-group">
