				...
				<div class="tabbable">
					...
					<div class="tab-content">
						<div class="tab-pane in active">
							<form  id="ajaxForm" class="form-horizontal" action='<?php echo U("Company/update");?>' method="post">
								<input type="hidden" name="id" value="<?php echo ($data["id"]); ?>"/>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" > 企业名称</label>
									<div class="col-sm-9">
										<input type="text"  name="cname" class="col-xs-10 col-sm-5" value="<?php echo ($data["cname"]); ?>"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right">所在城市</label>
									<div class="col-sm-2">
										<select class=" width-80 form-control" name="nowcid">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text"  name="address" class="col-xs-10 col-sm-5" value="<?php echo ($data["address"]); ?>"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right">企业规模</label>
									<div class="col-sm-3">
										<select class=" width-80 form-control" name="sizeid">
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right">公司性质</label>
									<div class="col-sm-3">
										<select class=" width-80 form-control" name="attrid">
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<select class=" width-80 form-control" name="industryid">
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" > 一句话介绍</label>
									<div class="col-sm-9">
										<input type="text"  name="one" class="col-xs-12 col-sm-8" value="<?php echo ($data["one"]); ?>"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"> 企业介绍 </label>
									<div class="col-sm-9">
										<textarea  class="col-xs-8" rows="8" name="description"><?php echo ($data["description"]); ?></textarea>

									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" > 企业网站</label>
									<div class="col-sm-6">
										<input type="text"  name="website" class="col-xs-6 col-sm-8" value="<?php echo ($data["website"]); ?>"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" > 联系人</label>
									<div class="col-sm-6">
										<input type="text"  name="contact" class="col-xs-6 col-sm-8" value="<?php echo ($data["contact"]); ?>"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" > 联系方式</label>
									<div class="col-sm-6">
										<input type="text"  name="phone" class="col-xs-6 col-sm-8" value="<?php echo ($data["phone"]); ?>"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" > Logo</label>
									<div class="col-sm-6">
										<img src="/Public<?php echo ($data["logo"]); ?>" alt="" width="180">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right">企业级别</label>
									<div class="col-sm-2">
										<select class=" width-80 form-control" name="level">
											<?php if(is_array($level)): foreach($level as $k=>$v): ?><option value="<?php echo ($k); ?>" <?php if(($data["level"]) == $k): ?>selected<?php endif; ?>><?php echo ($v); ?></option><?php endforeach; endif; ?>
										</select>
