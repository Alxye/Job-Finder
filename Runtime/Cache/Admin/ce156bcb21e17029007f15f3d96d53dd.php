	...
	<div class="row">
		...
		<div  style="margin-top:50px">
			<div class="tabbable tabs-left">
				<ul class="nav nav-tabs" id="resume">
					<li class="active">
				...
				<div class="tab-content padding-30">
					<div id="basic" class="tab-pane in active col-xs-12">
						<p class="lead">姓名：<?php echo ($truename); ?>&nbsp;&nbsp;&nbsp;性别：<?php echo ($sex); ?>&nbsp;&nbsp;&nbsp;出生日期：<?php echo ($birthday); ?></p>
						<p class="lead">邮箱：<?php echo ($email); ?></p>
						<p class="lead">联系电话：<?php echo ($phone); ?></p>
						<p class="lead">当前状态：<?php echo ($status); ?></p>
						<p class="lead">学历：<?php echo ($eid); ?></p>
						<p class="lead">自我描述：<?php echo ($desc); ?></p>
						<p class="lead">现居地：<?php echo ($nowcid); ?>&nbsp;&nbsp;&nbsp;籍贯：<?php echo ($oldcid); ?></p>
						<p class="lead">期望城市：<?php echo ($hopecid); ?>&nbsp;&nbsp;&nbsp;期望职位：<?php echo ($hopejob); ?>&nbsp;&nbsp;&nbsp;期望薪资：<?php echo ($hopepay); ?></p>
					</div>

					<div id="edu" class="tab-pane">
						<p class="lead">学历：<?php echo ($eid); ?>&nbsp;&nbsp;&nbsp;专业：<?php echo ($specialty); ?></p>
						<p class="lead">起止日期：<?php echo ($esdate); ?>&nbsp;&nbsp;&nbsp;毕业学校：<?php echo ($school); ?></p>
					</div>

					<div id="pro" class="tab-pane">
						<p class="lead">项目名称：<?php echo ($name); ?></p>
						<p class="lead">起止日期：<?php echo ($psdate); ?>&nbsp;&nbsp;&nbsp;担任职务：<?php echo ($post); ?></p>
						<p class="lead">项目描述：<?php echo ($prodesc); ?></p>
					</div>

					<div id="work" class="tab-pane">
						<p class="lead">企业名称：<?php echo ($comid); ?>&nbsp;&nbsp;&nbsp;职位名称：<?php echo ($job); ?>&nbsp;&nbsp;&nbsp;薪资：<?php echo ($pay); ?></p>
						<p class="lead">起止日期：<?php echo ($sdate); ?>&nbsp;&nbsp;&nbsp;工作描述：<?php echo ($wdesc); ?></p>
					</div>
				</div>
			</div>
		</div>
