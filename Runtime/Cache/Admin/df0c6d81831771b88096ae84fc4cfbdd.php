			...
			<div class="row">
				<div class="tabbable">
					...
					<div class="tab-content">
						<div class="row">
							<div class="col-xs-4">
								<form class="form-horizontal" id="ajaxForm" action='<?php if((ACTION_NAME) == "edit"): echo U("Admin/update"); else: echo U("Admin/insert"); endif; ?>' method="post">
									<input type="hidden" name="userid" value="<?php echo ($_GET['uid']); ?>"/>
									<div class="space-10"></div>
									<?php if((ACTION_NAME) == "add"): ?><div class="form-group">
										<label class="col-sm-3 control-label"> 用户账号 </label>
										<div class="col-sm-9">
											<input type="text"  name="username" value="" class="col-xs-9"/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label"> 用户密码 </label>
										<div class="col-sm-9">
											<input type="password"  name="password" value="" class="col-xs-9"/>
										</div>
									</div><?php endif; ?>
									<div class="form-group">
